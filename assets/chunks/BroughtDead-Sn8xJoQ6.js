import{d as N,o as k,W as R,q as b,v,t as s,r,u as L,j as u,A as a,B as A,x as m,k as E,z as S,s as O,K as P,f as x}from"../index-DBJxVvi5.js";import{F as T,aA as V}from"./index-a2IQmcsu.js";import{T as $}from"./Toolbar-Dp_HGVYo.js";import{D as w}from"./Alerts-DHYK-tHO.js";import{R as G}from"./ReusableDataTable-DKWFTpe_.js";import{G as U}from"./GoBack-C-Drr2w-.js";import{l as z}from"./aetc_brought_in_dead_service-D-CdjYzT.js";import{o as F}from"./workerStore-DEY2GV4Q.js";import{_ as K}from"./_plugin-vue_export-helper-DlAUqK2U.js";const j={class:"bid-list-page"},q={class:"list-toolbar"},H={class:"list-toolbar-primary"},J={key:0,class:"load-error",role:"alert"},M=N({__name:"BroughtDead",setup(W){const d=L(),l=r([]),c=r(!1),o=r(""),p=r(0);let f=null;const y=["First Name","Last Name","Age","National ID","Place of Death","Date of Death","Sex","Brought By","Confirmed By","Confirmation Date","Actions"],D={responsive:!0,ordering:!1,buttons:[],pageLength:10,language:{emptyTable:"No brought in dead records found",zeroRecords:"No matching brought in dead records found"}},h=t=>{if(!t||t==="N/A")return"N/A";const e=new Date(String(t));return Number.isNaN(e.getTime())?String(t):e.toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"})},_=t=>{const e=JSON.stringify({patientId:t.patientId,patientLookupIds:t.patientLookupIds});return`
