import{d as y,S as v,k as R,o as S,aV as A,B,E as c,D as l,f as C,u as L,z as N,b as a,K as P,R as $}from"../index-DEsEMTjW.js";import{G as h}from"./GoBack-C53zphuY.js";import{T as D}from"./Toolbar-Cd8iYjWn.js";import{R as I}from"./ReusableDataTable-BuwaACSM.js";import{i as n}from"./svg-D0Xk2Rxf.js";import{c as k,a as x}from"./Alerts-ISYCR3J9.js";import H from"./CPR-w9-LaMoz.js";import{d}from"./GlobalPropertyStore-BXojZlJ8.js";import{closeVisit as O}from"./visits_service-DnrvBCvi.js";import{H as s}from"./service-CbCR8O63.js";import{usePatientList as U}from"./patientListStore-G43cdb0l.js";import{u as V}from"./useAETCStageRealtime-DujPrfLI.js";import{_ as E}from"./_plugin-vue_export-helper-DlAUqK2U.js";const F=y({__name:"TriageList",setup(J){const o=C([]),u=L(),b=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Aggregate","Registered By","Action"],f={responsive:!0,ordering:!1,buttons:[]},r=U(),{AETCTriageList:m}=v(r),e=()=>{o.value=m.value.map(t=>[t.visit_number,t.given_name,t.family_name,s.toStandardHisTimeFormat(t.arrival_time),s.waitingTime(t.latest_encounter_time),s.waitingTime(t.arrival_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id})])},{setupStageRealtimeUpdates:p,teardownStageRealtimeUpdates:g}=V({onUpdated:e}),_=t=>`
