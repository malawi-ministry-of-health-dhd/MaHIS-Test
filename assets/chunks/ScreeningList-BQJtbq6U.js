import{d as R,L as h,w as T,o as A,W as L,q as B,v as p,t as u,r as C,u as N,j as $,A as i,B as x,K as H}from"../index-CraHIgRC.js";import{G as O}from"./GoBack-BRKI1Y9u.js";import{T as U}from"./Toolbar-Jc9EkRM9.js";import{R as k}from"./ReusableDataTable-pJOp13yn.js";import{i as o}from"./svg-D4Mhbd11.js";import{c as F,a as J}from"./Alerts-DsWtgBh2.js";import V from"./CPR-jPAe8nf6.js";import{usePatientList as W}from"./patientListStore-wUXfkm8e.js";import{H as f}from"./service-COQH2Mqp.js";import{d as b}from"./GlobalPropertyStore-CLFJEPVK.js";import{closeVisit as E}from"./visits_service-IFVd8jtm.js";import{u as G}from"./useAETCStageRealtime-BYa8X9_w.js";import{useDemographicsStore as M}from"./DemographicStore-CI2FLfIE.js";import{toastWarning as j}from"./toasts-D_8vvGaA.js";import{_ as q}from"./_plugin-vue_export-helper-DlAUqK2U.js";const K=R({__name:"ScreeningList",setup(w){const r=C([]),g=N(),_=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Attended By","Action"],I={responsive:!0,ordering:!1,buttons:[]},y=M(),c=W(),{AETCScreeningList:d}=h(c),m=t=>{const e=t?.patient||{},s=t?.identifier??t?.ID??e?.identifier??e?.ID;return{patient_id:t?.patient_id??t?.patientID??t?.person_id??e?.patient_id??e?.patientID??e?.person_id,identifier:s,ID:s}},a=()=>{r.value=d.value.map(t=>[t.visit_number,t.given_name,t.family_name,f.toStandardHisTimeFormat(t.arrival_time),f.waitingTime(t.latest_encounter_time),t.last_encounter_creator,P(m(t))])},{setupStageRealtimeUpdates:D,teardownStageRealtimeUpdates:S}=G({onUpdated:a}),P=t=>`
