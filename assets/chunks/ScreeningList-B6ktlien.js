import{d as S,S as v,k as T,o as R,aV as A,B,E as c,D as m,f as C,u as L,z as N,b as a,K as P,R as $}from"../index-DEsEMTjW.js";import{G as h}from"./GoBack-C53zphuY.js";import{T as D}from"./Toolbar-Cd8iYjWn.js";import{R as I}from"./ReusableDataTable-BuwaACSM.js";import{i}from"./svg-D0Xk2Rxf.js";import{c as k,a as x}from"./Alerts-ISYCR3J9.js";import H from"./CPR-w9-LaMoz.js";import{usePatientList as O}from"./patientListStore-G43cdb0l.js";import{H as l}from"./service-CbCR8O63.js";import{d}from"./GlobalPropertyStore-BXojZlJ8.js";import{closeVisit as U}from"./visits_service-DnrvBCvi.js";import{u as V}from"./useAETCStageRealtime-DujPrfLI.js";import{_ as E}from"./_plugin-vue_export-helper-DlAUqK2U.js";const F=S({__name:"ScreeningList",setup(J){const s=C([]),u=L(),b=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Attended By","Action"],f={responsive:!0,ordering:!1,buttons:[]},o=O(),{AETCScreeningList:r}=v(o),e=()=>{s.value=r.value.map(t=>[t.visit_number,t.given_name,t.family_name,l.toStandardHisTimeFormat(t.arrival_time),l.waitingTime(t.latest_encounter_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id})])},{setupStageRealtimeUpdates:p,teardownStageRealtimeUpdates:g}=V({onUpdated:e}),_=t=>`
