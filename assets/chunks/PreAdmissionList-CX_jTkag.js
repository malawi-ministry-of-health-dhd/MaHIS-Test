import{d as C,T as $,k as q,B as x,E as b,D as _,e as c,f as k,u as E,j as L,z as M,b as m,K as W,R as F}from"../index-DF8nt3yL.js";import{T as G}from"./Toolbar-BsS6oVsG.js";import{R as H}from"./ReusableDataTable-BXKWRrbs.js";import{G as V}from"./GoBack-CiHLEaDH.js";import{c as J}from"./Alerts-BJxCY5Ss.js";import{i as v}from"./svg-D4Mhbd11.js";import{P as j}from"./patient_opd_list-DvrScM3Z.js";import{P as z,H as g}from"./service-C93KdSyZ.js";import{useDemographicsStore as K}from"./DemographicStore-CcFGodFH.js";import Q from"./CPR-Dpf_MlPH.js";import{r as U}from"./ipd_context-SiJu3uwp.js";import{O as X}from"./GlobalPropertyStore-BPcMTq01.js";import{E as Y}from"./encounter_type-DsGXMrG7.js";import{B as Z}from"./BedService-BGaS9gjW.js";import{toastWarning as I}from"./toasts-LLD-KJ1a.js";import{_ as tt}from"./_plugin-vue_export-helper-DlAUqK2U.js";const et=C({__name:"PreAdmissionList",setup(at){const o=E(),s=L(),y=K(),u=k([]),h=["Visit No","First Name","Last Name","MRN","Gender","Arrival Time","Waiting Time","Ward","Actions"],P={responsive:!0,ordering:!1,buttons:[]},l=U(),p=c(()=>String(s.query.department||l.department||"").trim()),r=c(()=>String(s.query.ward||l.ward||"").trim()),d=c(()=>String(s.query.wardId||l.wardId||"").trim()),A=c(()=>`Patients Awaiting Admission${r.value?` - ${r.value}`:""}`),N=e=>`
