import{d as S,S as v,k as T,o as R,a2 as A,B,E as c,D as m,f as C,u as L,z as N,b as a,K as P,R as $}from"../index-CdygPD4q.js";import{G as h}from"./GoBack-BdQnlDQc.js";import{T as D}from"./Toolbar-BR5cjK0S.js";import{R as I}from"./ReusableDataTable-BxnEzRa-.js";import{i}from"./svg-D4Mhbd11.js";import{c as k,a as x}from"./Alerts-DJLSj_NO.js";import H from"./CPR-BFfd9djd.js";import{usePatientList as O}from"./patientListStore-EySSoS6V.js";import{H as l}from"./service-GJ_y7eWt.js";import{d}from"./GlobalPropertyStore-jUf1_nX0.js";import{closeVisit as U}from"./visits_service-M08Cl8j3.js";import{u as E}from"./useAETCStageRealtime-D8XHEkZ6.js";import{_ as F}from"./_plugin-vue_export-helper-DlAUqK2U.js";const J=S({__name:"ScreeningList",setup(V){const s=C([]),u=L(),b=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Attended By","Action"],f={responsive:!0,ordering:!1,buttons:[]},o=O(),{AETCScreeningList:r}=v(o),e=()=>{s.value=r.value.map(t=>[t.visit_number,t.given_name,t.family_name,l.toStandardHisTimeFormat(t.arrival_time),l.waitingTime(t.latest_encounter_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id})])},{setupStageRealtimeUpdates:p,teardownStageRealtimeUpdates:g}=E({onUpdated:e}),_=t=>`
